...
pretrained_model_path = './checkpoints/WFTFC/WFTFC_all_v727_epoch_100.pth.tar' # 指向你预训练好的模型
...
# 保存微调后的模型
torch.save(model.state_dict(), './checkpoints/WFTFC/WFTFC_all_v727_finetuned.pth.tar')
